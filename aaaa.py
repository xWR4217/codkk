...
print(merah+"[!]"+kuning+" Silahkan membeli fitur premium untuk tool-facebook.")
...
if f =="y":
    subprocess.check_output(
								["am","start",
				"https://api.whatsapp.com/send?phone=6285608035292&text=hello%20admin%20saya%20ingin%20membeli%20tool - facebook%20premium%20Seharga%2010k"])
